...
class AsteroidAdapter(val clickListener: AsteroidItemListListener) :
    ...
    class AsteroidViewHolder(private val binding: ListItemAsteroidBinding) :
        ...
        fun bind(clickListener: AsteroidItemListListener, item: Asteroid) {
...
class AsteroidItemListListener(val clickListener: (asteroid: Asteroid) -> Unit) {
